...
/**
 * MIGRATION 6 -> 7
 * Adiciona vantagem e desvantagem na tabela de pericias (Modo Investigacao/Horror)
 */
val MIGRATION_6_7 = object : Migration(6, 7) {
    override fun migrate(database: SupportSQLiteDatabase) {
        database.execSQL("""
            ALTER TABLE pericias 
            ADD COLUMN vantagem INTEGER NOT NULL DEFAULT 0
        """)
        database.execSQL("""
            ALTER TABLE pericias 
            ADD COLUMN desvantagem INTEGER NOT NULL DEFAULT 0
        """)
    }
}
